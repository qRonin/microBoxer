namespace Identity.API.Configuration
{
    public class Config
    {
        ...
        public static IEnumerable<ApiResource> GetApis()
        {
            ...
            {
                new ApiResource("boxes", "BoxesService"),
        ...
        public static IEnumerable<ApiScope> GetApiScopes()
        {
            ...
            {
                new ApiScope("boxes", "BoxesService"),
        ...
        public static IEnumerable<Client> GetClients(IConfiguration configuration)
        {
            return new List<Client>
            {
                ...
                new Client
                {
                    ClientId = "boxesswaggerui",
                    ClientName = "Boxes Swagger UI",
                    AllowedGrantTypes = GrantTypes.Implicit,
                    AllowAccessTokensViaBrowser = true,

                    RedirectUris = { $"{configuration["BoxesApiClient"]}/swagger/oauth2-redirect.html" },
                    PostLogoutRedirectUris = { $"{configuration["BoxesApiClient"]}/swagger/" },
